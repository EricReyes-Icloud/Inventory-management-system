...
Automated test execution via GitHub Actions on pull requests and pushes to main/develop. Ensures the full test suite runs deterministically before code merges, with zero secrets and minimal configuration.
